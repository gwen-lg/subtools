...
// TODO: work context as struct than carry some object than implement trait, lique Progress, sub_process_creator, a writer

/// struct to store the context éléments.
